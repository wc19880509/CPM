...
public:
	...
	static void SmoothFlowPDE(const DImage& Im1, const DImage& Im2, DImage& warpIm2,
		DImage& vx, DImage& vy,
		double alpha, int nOuterFPIterations, int nInnerFPIterations, int nCGIterations);
	
	static void SmoothFlowSOR(const DImage& Im1,const DImage& Im2, DImage& warpIm2,
		DImage& vx, DImage& vy,
	...
	static void Coarse2FineFlowLevel(DImage& vx, DImage& vy, DImage &warpI2, const DImage& Im1, const DImage& Im2,
	...
	static void ComputeOpticalFlow(const DImage& Im1, const DImage& Im2, DImage& vx, DImage& vy,
		double alpha, double ratio, int minWidth,
		int nOuterFPIterations, int nInnerFPIterations, int nCGIterations)
	{
		...
		if(!vx.matchDimension(Im1.width(),Im1.height(),1))
			vx.allocate(Im1.width(),Im1.height(),1);
		if(!vy.matchDimension(Im1.width(),Im1.height(),1))
			vy.allocate(Im1.width(),Im1.height(),1);
		...
		int nOuterFPIterations, int nInnerFPIterations, int nCGIterations)
	{
		...
		DImage vx, vy, warpI2;
		Coarse2FineFlow(vx, vy, warpI2, Im1, Im2, alpha, ratio, minWidth, nOuterFPIterations, nInnerFPIterations, nCGIterations);
